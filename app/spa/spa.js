...
angular.module('myApp.spa', ['ngRoute'])

.config(['$routeProvider', function($routeProvider) {
  $routeProvider.when('/beer-spa', {
    templateUrl: 'spa/spa.html',
    controller: 'spaSVKCtrl'
  });
    $routeProvider.when('/pension-eng', {
        templateUrl: 'spa/spa.html',
        controller: 'spaENGCtrl'
    });
}])

    .controller('spaSVKCtrl', [function() {
